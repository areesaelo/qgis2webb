...
lyr_StamenToner_0.setVisible(true);lyr_pl_tambon_1.setVisible(true);lyr_pl_amphoe_2.setVisible(true);lyr_pl_stream_3.setVisible(true);lyr_pl_transportation_4.setVisible(true);lyr_pl_village_5.setVisible(true);
var layersList = [lyr_StamenToner_0,lyr_pl_tambon_1,lyr_pl_amphoe_2,lyr_pl_stream_3,lyr_pl_transportation_4,lyr_pl_village_5];
...
lyr_pl_village_5.set('fieldLabels', {'NRD_CODE': 'header label', 'VILL_CODE': 'no label', 'VILL_NAM_T': 'no label', 'PROV_CODE': 'no label', 'AMP_CODE': 'no label', 'TAM_CODE': 'no label', });
